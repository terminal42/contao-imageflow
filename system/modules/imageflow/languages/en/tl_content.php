...
$GLOBALS['TL_LANG']['tl_content']['ifAddSlideShow']			= array('Slideshow', 'Enable for the slideshow.');
$GLOBALS['TL_LANG']['tl_content']['ifSlideShowSpeed']		= array('Speed', 'Enter the time between slides in ms.');
$GLOBALS['TL_LANG']['tl_content']['ifSlideShowAutoPlay']	= array('Autoplay', 'Enable for autoplay on start.');
...
$GLOBALS['TL_LANG']['tl_content']['ifConfigBlob']['glideToStartID']		= 'Glide to start image';
